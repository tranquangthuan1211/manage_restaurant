    ...
    export const RegisterLogin = () => {
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                if (response.error === 0) {
                    showSnackbarSuccess("Registration successful!");
                    console.log("Registration successful:", response.message);
                    console.log("User data:", response);
                    return;
                }
                showSnackbarError("Registration failed with unknown error");
                console.log("Registration failed with unknown error");
            } catch (error) {
                showSnackbarError("Registration failed");
                ...
                {step === 2 ? (
                    <Box>
                        <Stack spacing={1} sx={{ marginBottom: '20px' }}>
                            <Typography variant="h6" sx={{ color: '#FFFF', mb: 2, fontWeight: 'bold' }}>
                                User name
                            </Typography>
                            <TextField
                                label="User name"
                        ...
                        <Box sx={{ display: 'flex', gap: '10px', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            <Button
                                variant="contained"
                                fullWidth
                                sx={{
