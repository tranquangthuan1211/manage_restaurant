...
const PreorderDishesTabDessert: React.FC = () => {
            ...
            <div className="p-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex space-x-6 m-5 justify-center gap-5">
                        ...
                        <a href="/preorder-dishes/dessert" className="text-yellow-600 font-bold flex items-center">
...
export default PreorderDishesTabDessert;
