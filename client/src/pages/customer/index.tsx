        ...
        <RootLayout>
            <div>
                ...
                <div className="col-span-full bg-[url('/images/customer_bg2.jpg')] lg:bg-[url('/images/customer_bg1.jpg')] bg-cover bg-center h-[36rem] grid grid-cols-12">
                    ...
                    <div className="col-span-full lg:col-span-6 flex justify-center lg:justify-start lg:pl-8 items-center">
                        <div className="relative w-full h-56 lg:w-96 lg:h-96">
                            {/* Main Dish */}
                            <img
                                className={`object-center object-cover w-full h-full transition-all duration-${FADE_DURATION} ${fade ? "opacity-0 lg:scale-90" : "opacity-100 lg:scale-100"
                                    } ${
                                    // Rectangular on <= lg, circular on > lg
                                    "lg:rounded-full lg:p-10"
                                    }`}
