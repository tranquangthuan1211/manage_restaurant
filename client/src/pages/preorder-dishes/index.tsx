...
const menuItems = [
    { id: 1, name: 'Burger King', price: 5, image: '/images/burger.png' },
    { id: 2, name: 'Spaghetti', price: 5, image: '/images/spaghetti.png' },
    { id: 3, name: 'Greek Salad', price: 5, image: '/images/greek-salad.png' },
    { id: 4, name: 'Pho Bo', price: 5, image: '/images/Pho bo.png' },
    { id: 5, name: 'Papaya Salad', price: 5, image: '/images/papaya.png' },
    { id: 6, name: 'Com Tam', price: 5, image: '/images/com-tam.png' },
    { id: 7, name: 'Pancake', price: 5, image: '/images/pancake.png' },
    { id: 8, name: 'Banh da lon', price: 5, image: '/images/banhdalon.png' },
    { id: 9, name: 'Wine', price: 5, image: '/images/wine.png' },
    { id: 10, name: 'Juice', price: 5, image: '/images/juice.png' },
];
            ...
            <div className="p-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex space-x-6 m-5 justify-center gap-5">
                        <a href="/preorder-dishes" className="text-yellow-600 font-bold flex items-center">
                        ...
                        <a href="/preorder-dishes/vietnam" className="text-black font-bold flex items-center">
