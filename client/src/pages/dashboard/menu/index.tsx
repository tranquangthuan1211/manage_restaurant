...
const tabs = [
  { label: "Đồ Ăn", key: "Đồ Ăn" },
  { label: "Đồ Uống", key: "Đồ Uống" },
];
...
const Page: PageType = () => {
  ...
  return (
    <Stack spacing={2}>
      ...
      />
      {tab === tabs[0].key && (
        <Stack spacing={2} sx={{ backgroundColor: "#f9f9f9" }}>
          <FoodTabel foods={getMenu.data || []} loading={getMenu.loading} error={getMenu.error} />
        </Stack>
      )}
    </Stack>
  );
